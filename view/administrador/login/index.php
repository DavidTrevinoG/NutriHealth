...
<head>
    ...
    <title>Formulario de Inicio de Sesión de Administrador</title>
    <!-- Bootstrap CSS -->
                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        <form action="php/login.php" method="POST">
                            ...
                            <button type="submit" class="btn btn-primary btn-block" name="login" id="login">Iniciar Sesión</button>
                        </form>
                    </div>
                </div>
            </div>
